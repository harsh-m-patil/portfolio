...
const GitHubCopilotDark = (props: SVGProps<SVGSVGElement>) => (
...
const GitHubCopilotLight = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} preserveAspectRatio="xMidYMid" viewBox="0 0 256 208">
    <title>GitHub Copilot</title>
...
export const GitHubCopilot = (props: SVGProps<SVGSVGElement>) => {
  return (
    <>
      <GitHubCopilotDark className="hidden dark:block" {...props} />
      <GitHubCopilotLight className="dark:hidden" {...props} />
    </>
  );
};
