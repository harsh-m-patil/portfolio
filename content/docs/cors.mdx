...
description: understanding Cross-Origin Resource Sharing (CORS) and building a simple CORS middleware in TypeScript.
imageUrl: "/blogs/cors/banner.png"
---
...
<Callout title="Note">
  This restriction is enforced only by browsers. If you use `curl`, `Postman`,
  or server-side code, CORS does **not** apply—because the check happens in the
